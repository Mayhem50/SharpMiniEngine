...
namespace Core
{
  public static class BitScanner
  {
    public static int BitScanForward(uint value)
    {
      ...
      return MultiplyDeBruijnBitPosition[(value & -value) * 0x077CB531];
    }
    ...
    public static int BitScanForward64(UInt64 value)
    {
      int[] MultiplyDeBruijnBitPosition =
     {
      ...
      return MultiplyDeBruijnBitPosition[((ulong)((long)value & -(long)value)) * 0x37E84A99DAE458F];
    }
    public static int BitScanReverse64(UInt64 value)
    {
      int[] MultiplyDeBruijnBitPosition =
      {
        0, 1, 17, 2, 18, 50, 3, 57,
      ...
      value |= value >> 32;
      value = value & ~(value >> 1);
      return MultiplyDeBruijnBitPosition[value * 0x37E84A99DAE458F >> 58];
    }
  }
}
